			...
			<div class="row test_row">
				...
				<div class="col-lg-6 test_col">
					<div class="testimonial">
						...
						<div class="test_text">"Efficiency from all staff from the car park attendant right through to the nursing staff and doctors. A pleasant caring manner makes such a difference when you are receiving scary treatment. I cannot fault the Cromwell experience. Thank you."</div>
				...
				<div class="col-lg-6 test_col">
					<div class="testimonial">
						<div class="test_icon d-flex flex-column align-items-center justify-content-center"><img src="images/quote.png" alt=""></div>
						<div class="test_text">Very friendly staff from the nurses to doctors, to porters to security staff. All of whom make you at ease when you feel most vulnerable, as you are about to go for an operation. Thanks."</div>
						<div class="test_author d-flex flex-row align-items-center justify-content-start">
				...
				<div class="row">
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_about">
							...
							<div class="footer_about_text">
								<p>Hospitals are reservoirs of critical resources and knowledge. They can be classified according 
							...
							<ul class="footer_about_list">
									...
									<li><div class="footer_about_icon"><img src="images/envelope.svg" alt=""></div><span>caremed@gmail.com</span></li>
					...
					<div class="col-lg-4 footer_col">
						<div class="footer_news footer_column">
							...
							<ul>
								<li>
									<div class="footer_news_title"><a href="https://farmaline.be">Farmaline Pharmacy</a></div>
									
								</li>
								<li>
									<div class="footer_news_title"><a href="https://drugs.com">Drugs Pharmacy</a></div>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Group 4 <i class="fa fa-heart-o" aria-hidden="true"></i>
